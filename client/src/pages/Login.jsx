    ...
    <div className="relative min-h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-gray-800/50 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-600 bg-black/50 text-red-500 focus:ring-red-500 focus:ring-offset-0" />
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            Don't have an account? <Link to="/register" className="text-amber-500 hover:text-amber-400 font-medium transition-colors">Create one</Link>
          </p>
        </div>
      ...
      {showForgot && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-gray-900/90 backdrop-blur-xl p-6 rounded-lg shadow-2xl w-full max-w-md border border-gray-800/50">
            <h3 className="text-2xl font-semibold mb-4 text-white">
              {forgotStep === 1 ? 'Reset Password' : 'Enter OTP & New Password'}
            </h3>
            {forgotMsg && (
              <div className="mb-3 text-sm text-gray-300 bg-red-500/20 text-red-400 p-3 rounded">{forgotMsg}</div>
            )}
            {forgotStep === 1 ? (
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded bg-black/50 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500"
                  />
                </div>
                <div className="flex gap-2">
                  <button
                    className="flex-1 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-2 rounded transition-colors disabled:opacity-50"
